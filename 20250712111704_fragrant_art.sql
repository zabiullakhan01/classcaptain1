/*
  # Add student and teacher ID fields for login
...
-- Add teacher_id column to teachers table
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
...
-- Update existing students with generated student IDs
UPDATE students 
SET student_id = 'STU' || LPAD((ROW_NUMBER() OVER (ORDER BY created_at))::text, 4, '0')
WHERE student_id IS NULL;

-- Update existing teachers with generated teacher IDs
UPDATE teachers 
